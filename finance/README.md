...
- **Scenarios:** weak, middle and strong. Play volume and price mix come from the venue file. Maintenance, resale values, wear on owned machines and owner hours are shared.
- **Exits:** after 1, 2 and 3 years.
- **Lineups:** A = all four machines already owned; B = buy Pokémon new; C = buy Star Wars (with upgrades) and Pokémon new. `+R` adds two purchased used replacements after 4 months. The lineups exist because whether Star Wars and Pokémon are already owned is still **open**. If a venue has fewer than four slots, the last machines are dropped.
- **Kept separate:** new cash spent, market value of owned machines placed, operating cash, what the venue receives, owner hours, net resale proceeds, exit costs, and wear on owned machines (a real cost, but not cash).
...
4. **Purchased replacements after 4 months make the middle case about $2,500–$4,700 worse** and add about $15,600 of new cash before there's data on the venue.
